...
function putCreator(store, namespace) {
  ...
  return function (_ref) {
    var type = _ref.type,
        rest = objectWithoutPropertiesLoose(_ref, ["type"]);
    ...
    if (types.length >= 2) {
      ...
      return store.dispatch(_extends_1({
        type: type
      }, rest));
    }
...
function () {
  function Model(opts) {
    ...
    this.actions = this.createActions(_extends_1({}, reducers, effects));
  ...
  _proto.createReducer = function createReducer(reducers) {
    ...
    var _reducers = keys$1(reducers).reduce(function (combine, key) {
      var _extends2;
      ...
      return _extends_1({}, combine, (_extends2 = {}, _extends2[type] = reducer, _extends2));
    }, {});
  ...
  _proto.createActions = function createActions(actions) {
    ...
    return keys$1(actions).reduce(function (combine, name) {
      var _extends3;

      return _extends_1({}, combine, (_extends3 = {}, _extends3[name] = function (payload, meta, error) {
        return {
  ...
  _proto.createEffects = function createEffects(effects) {
    ...
    return keys$1(effects).reduce(function (combine, key) {
      var _extends4;
      ...
      return _extends_1({}, combine, (_extends4 = {}, _extends4[type] = effect, _extends4));
    }, {});
  };
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 15:
                  ...
                  return _context.abrupt("return", promise$1.reject(_context.t0));
...
function () {
  ...
  _proto.getRootReducer = function getRootReducer() {
    ...
    var rootReducer = keys$1(this.models).reduce(function (combine, namespace) {
      var _extends2;

      var model = _this.models[namespace];
      var reducers = model.getReducers();
      return _extends_1({}, combine, (_extends2 = {}, _extends2[namespace] = reducers, _extends2));
    }, {});
  ...
  _proto.getEffects = function getEffects() {
    ...
    return keys$1(this.models).reduce(function (effects, namespace) {
      var model = _this2.models[namespace];
      return _extends_1({}, effects, model.getEffects());
    }, {});
  };
  ...
  _proto.getDefaultState = function getDefaultState() {
    ...
    return keys$1(this.models).reduce(function (defaultState, namespace) {
      ...
      if (modelState !== undefined) {
        ...
        return _extends_1({}, defaultState, (_extends3 = {}, _extends3[namespace] = model.getDefaultState(), _extends3));
      }
  ...
  _proto.createStore = function createStore$$1() {
    ...
    return _createStore({
      ...
      initialState: _extends_1({}, this.initialState, pluginInitialState || {}, this.getDefaultState())
    });
  };
  ...
  _proto.setupModel = function setupModel(models) {
    ...
    keys$1(models).forEach(function (namespace) {
...
function dispatcherCreator (namespace, model, zoro) {
  ...
  if (!actionCache[namespace]) {
    ...
    actionCache[namespace] = keys$1(actions).reduce(function (dispatcher, name) {
      var _extends2;

      return _extends_1({}, dispatcher, (_extends2 = {}, _extends2[name] = function () {
